...
def init_sync():
    global config, epoch_bloom_filter, current_pkcs, to_register_clients_pkcs, to_unregister_clients_pkcs, epoch_set
...
def packet_handler(frame):
    global epoch_bloom_filter, lock, epoch_set
...
def handle_bloom_filters():
    global epoch_bloom_filter, epoch_start_timestamp, epoch_end_timestamp, epoch_set
    ...
    for pkc, serializedPkc in current_pkcs_copy:
        ...
        epoch_result["epoch_set"] = list(epoch_set_copy)
